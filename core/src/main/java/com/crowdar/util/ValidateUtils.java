...
public class ValidateUtils {
    ...
    private static <T> void sort(List<T> expectedList, Class expectedClass) throws IllegalAccessException, InvocationTargetException {
        try {
            ...
            LoggerService.getLogger(ValidateUtils.class).warn(">>> 'sort' method was not found in ".concat(expectedClass.toGenericString()).concat(". Proceeding without sorting the list."));
        }
    }
    ...
    private static Object tryGetMethodValue(Object actual, Class actualClass, String expectedKey) throws IllegalAccessException, InvocationTargetException {
        try {
            ...
            LoggerService.getLogger(ValidateUtils.class).warn(">>> Method ".concat(getMethodName()).concat(" was not found. Trying with capitalize."));
