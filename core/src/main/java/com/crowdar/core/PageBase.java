...
abstract public class PageBase {
     ...
     * Method that clicks the element specific
     *
     * @param webelement to be clickable
     */
     ...
     *
     * @param dropdown locator that i want to open
     * @param value    of the option that i want to choose
     */
     ...
     *
     * @param dropdownTitleTranslateKey the of the title label
     * @param value                     of the option that i want to choose
     */
     ...
     * request
     *
     * @param SeleniumWebDriver for Angular
     */
